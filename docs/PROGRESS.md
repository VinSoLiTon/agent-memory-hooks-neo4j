...
| #28 | open | Phase B (PR-2) — canonical `event_schema.py` (OTel `gen_ai.*` + read-time upcasting, v2 app_id) + DLQ-rate health; all 6 acceptance bars met → **Phase B complete** |

## Metrics

- Tests: **19 → 149** over the program (live Neo4j + pure).
